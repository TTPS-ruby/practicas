...
> lenguaje utilices, es importante que utilices una versión relativamente reciente (`3.1`
> o posterior).
...
11. Tomando el ejercicio anterior como referencia, ¿en qué situaciones usarías los métodos
    [`send`](https://ruby-doc.org/3.1.6/Object.html#method-i-send) y
    [`public_send`](https://ruby-doc.org/3.1.6/Object.html#method-i-public_send)
