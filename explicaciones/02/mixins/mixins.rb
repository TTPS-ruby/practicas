# Ejemplo de uso de módulos como Mixins para el Taller de Tecnologías de Producción de
# Software - Opción Ruby.
#
# Este script muestra _una_ forma de utilizar módulos en Ruby como interfaces con
# comportamiento o, lo que es similar, como un mecanismo de herencia horizontal entre
# clases de diferentes jerarquías (también conocida como "herencia múltiple").
#
# En este ejemplo demostraremos, además, un patrón común para definir métodos de instancia
# y de clase en un mismo Mixin mediante el uso del módulo `ClassMethods` (el nombre no es
# obligatorio).
#
# Contexto
#
# Se nos pide implementar un módulo que permita almacenar en memoria instancias de distintas
# clases, permitiendo utilizar así un mecanismo muy sencillo de caching de objetos. Ya
# disponemos de una clase `ACME::Storage` para utilizar que mantiene un diccionario de
# claves y valores, agrupados por el _tipo_ de cada valor que se obtiene mediante el envío
...
# * `Office`
#
# Cada una de estas clases posee sus propios atributos y lógica que exceden el alcance de
# este ejemplo, por lo que vamos a obviarlos, simplemente agregando algunos atributos como
# para que las pruebas tengan sentido.
#
# Referencias
#
...
# Estos archivos que incluimos son la implementación del ejemplo. En este archivo
# únicamente haremos uso de lo que se define en ellos, a modo de ensayo y prueba de cómo
# podrían utilizarse esas clases y módulos.
